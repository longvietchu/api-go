...
type TestCase struct{
	...
	HandlerFunc func(s *configs.Server, c echo.Context) error
	QueryMock   *QueryMock
...
func PrepareContextFromTestCase(s *configs.Server, test TestCase) (c echo.Context, recorder *httptest.ResponseRecorder) {
